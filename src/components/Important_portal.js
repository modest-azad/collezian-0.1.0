        ...
        <>
            ...
            <div className="important-portal rounded-3xl md:mx-[10%]">
                ...
                <a href="null" className="item transition-all duration-300 ease-in-out hover:translate-y-[-1em] ">
                        <img className="w-full p-4" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRKUd5HnBqh0VBnFzcWlyz_32Az6uxtP1ahatKFttg&s" alt="image" />
                        <h2>NPTEL</h2>
                    </a>
                    <a href="null" className="item transition-all duration-300 ease-in-out hover:translate-y-[-1em]">
                        <img className="w-full p-4" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSbnc1-B3W16TYnS90yvfhDhyRfpKdNQO1V2dbvLuA-8Q&s"   alt="image" />
                    ...
                    <a href="null" className="item transition-all duration-300 ease-in-out hover:translate-y-[-1em]">
                        <img className="w-full p-4" src="https://upload.wikimedia.org/wikipedia/commons/4/4a/National_Digital_Library_of_India.png" alt="image" />
                        <h2>National Digital Library</h2>
                    </a>
                    <a href="null" className="item transition-all duration-300 ease-in-out hover:translate-y-[-1em]">
                        <img className="w-full p-4" src="https://asset.brandfetch.io/id27aU8Kyu/id97pzxNTf.jpeg" alt="image" />
